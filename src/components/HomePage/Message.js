...
export const Message = ({ title, message, img }) => {
  return (
    <section className="p-4 md:px-10 flex flex-col md:flex-row items-center justify-center min-h-[calc(100vh-56px)] md:min-h-screen text-gray-100">
      ...
      <div className="hidden md:block w-1/2 p-8 lg:p-16 text-white md:order-2">
      ...
      <div className="hidden md:block w-1/2 p-8 xl:p-20 md:order-1">
